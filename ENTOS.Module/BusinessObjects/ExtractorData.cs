...
{
    [ModelDefault("Caption", "Dữ liệu trích"), ImageName("ExtractorData")]
	...
	[MobileColumnAttribute(Context = "BookMark_ExtractorDataList_ListView", TargetItems = nameof(Name))]
	[MobileColumnAttribute(Context = "ExtractorData_LookupListView", TargetItems = nameof(Name))]
	[MobileColumnAttribute(Context = "AIExtractorField_ExtractorDataList_ListView", TargetItems = "BookMark.Name"+ "," + nameof(Name))]
	[MobileColumnAttribute(Context = "ExtractorData_ListView", TargetItems = nameof(Name))]
	[DefaultProperty("Name")]
 
[OptimisticLocking(true)]
    public partial class ExtractorData:  DevExpress.Xpo.XPLiteObject  , INoIndexColumn, IOnViewObjectSpaceCommitted      //, HbBaseObject
    {
        public ExtractorData(Session session)
            : base(session) {              
        }
