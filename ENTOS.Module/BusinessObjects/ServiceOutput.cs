...
{
    [ModelDefault("Caption", "Đầu ra dịch vụ"), ImageName("ServiceOutput")]
    [ModelDefault("DefaultLookupEditorMode", "Auto")]
    //[DefaultListViewOptions(MasterDetailMode.ListViewOnly, false, NewItemRowPosition.None)]
	[Appearance("ServiceOutput DataTypeT2 Hide_None__" , TargetItems = "DataTypeT2" , Criteria = "[DataType] Is Null Or [DataType.GenericType] <> ##ToString#Generic2#",AppearanceItemType = "ViewItem", Visibility = ViewItemVisibility.Hide , Context = "DetailView" )]
	[Appearance("ServiceOutput DataTypeT1 Hide_None__" , TargetItems = "DataTypeT1" , Criteria = "[DataType] Is Null Or [DataType.GenericType] Is Null",AppearanceItemType = "ViewItem", Visibility = ViewItemVisibility.Hide , Context = "DetailView" )]
...
[OptimisticLocking(true)]
    public partial class ServiceOutput:  DevExpress.Xpo.XPLiteObject  , INoIndexColumn, IOnViewObjectSpaceCommitted      //, HbBaseObject
    {
        public ServiceOutput(Session session)
            : base(session) {              
        }
...
//Kết thúc khổi phải là đối tượng NonPersistent (không lưu CSDL)
   ...
   //             }
        ...
        {
            #region 3809ImportCode
            if (newValue is null) return;
SetDefaultOrder();            
            #endregion 3809ImportCode
        }               
...
#region 3522ImportCode
		public void SetDefaultOrder(View view = null)
        {
            //Code: 3522            Oid: 62053683-ea04-4a3b-b860-26bba350400f
            Order = GetDefaultOrder();
        }
#endregion 3522ImportCode
#region 3520ImportCode
		public int? GetDefaultOrder(View view = null)
        {
            //Code: 3520            Oid: 6ff19bbf-2088-4c80-b25d-bcce428e720c
            if (SoftwareServiceType != null && SoftwareServiceType.ServiceOutputList != null)
{
    var lasted = SoftwareServiceType.ServiceOutputList.Where(m => m.Order != null).OrderByDescending(m => m.Order).FirstOrDefault();
    if (lasted != null)
