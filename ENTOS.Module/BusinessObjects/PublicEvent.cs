...
namespace ENTOS.Module.BusinessObjects 
{
	...
	[DefaultClassOptions]
    [ModelDefault("Caption", "Sự kiện"), ImageName("PublicEvent")]
	...
	[MobileColumnAttribute(Context = "PublicEvent_LookupListView", TargetItems = nameof(Icon)+ "," + nameof(StartTime)+ "," + nameof(Code))]
	[MobileColumnAttribute(Context = "PublicEvent_ListView", TargetItems = nameof(Name)+ "," + nameof(StartTime)+ "," + nameof(Icon))]
	[DefaultProperty("Code")]
 
[OptimisticLocking(true)]
    public partial class PublicEvent:  DevExpress.Xpo.XPLiteObject  , INoIndexColumn, IOnViewObjectSpaceCommitted      //, HbBaseObject
    {
        public PublicEvent(Session session)
            : base(session) {              
        }
        ...
        public bool AppearanceDisableDelete
        {
            get
            {
                ...
                }else
                {
                    ...
                    {
                        //if (Session.FindObject<Module.BusinessObjects.ObjectRelation>(CriteriaOperator.Parse("[PublicEvent.Oid] = ?", Oid)) != null) //Loại này sẽ lấy cá tham chiếu
                        bool objectrelationlist = Session.Query<Module.BusinessObjects.ObjectRelation>().Where(x => x.PublicEvent.Oid == Oid).Take(1).Any(); //Tạo truy vấn top 1
                ...
                }else
                {
                    ...
                    {
                        //if (Session.FindObject<Module.BusinessObjects.Calendar>(CriteriaOperator.Parse("[PublicEvent.Oid] = ?", Oid)) != null) //Loại này sẽ lấy cá tham chiếu
                        bool calendarlist = Session.Query<Module.BusinessObjects.Calendar>().Where(x => x.PublicEvent.Oid == Oid).Take(1).Any(); //Tạo truy vấn top 1
                ...
                }else
                {
                    ...
                    {
                        //if (Session.FindObject<Module.BusinessObjects.Post>(CriteriaOperator.Parse("[PublicEvent.Oid] = ?", Oid)) != null) //Loại này sẽ lấy cá tham chiếu
                        bool postlist = Session.Query<Module.BusinessObjects.Post>().Where(x => x.PublicEvent.Oid == Oid).Take(1).Any(); //Tạo truy vấn top 1
...
//Kết thúc khổi phải là đối tượng NonPersistent (không lưu CSDL)
		...
		//[Index(0)]		
 		...
 		[Size(10)]
		[RuleUniqueValue("UniquePublicEventCode", DefaultContexts.Save, CriteriaEvaluationBehavior = CriteriaEvaluationBehavior.BeforeTransaction)]
		[RuleRequiredField("RequiredPublicEventCode", DefaultContexts.Save)]
		public string Code
        { 
		...
		//[Index(2)]		
 		...
 		[Size(100)]
		[RuleRequiredField("RequiredPublicEventName", DefaultContexts.Save)]
		public string Name
        { 
		...
		public override void AfterConstruction()
        {
            ...
            #region 0394ImportCode
            base.AfterConstruction();
SetDefaultUpdate();
            #endregion 0394ImportCode
        ...
        {
            #region 0504ImportCode
            base.OnSaving();
SetDefaultUpdate();
SetDefaultUpdater();
            #endregion 0504ImportCode
...
#region 3958ImportCode
		public Module.BusinessObjects.Member GetDefaultUpdater(View view = null)
        {
            //Code: 3958            Oid: fab16cdf-e1f1-4f09-b044-b13ec8590cf6
            return Module.Helpers.XafXpoHelper.GetCurrentUser<Member>(Session);
        }
#endregion 3958ImportCode
#region 0082ImportCode
		public void SetDefaultUpdate(View view = null)
        {
            //Code: 0082            Oid: 7d65bd9f-8421-405c-a2c1-8090a493784e
            Update = GetDefaultUpdate();
        }
#endregion 0082ImportCode
#region 3957ImportCode
		public void SetDefaultUpdater(View view = null)
        {
            //Code: 3957            Oid: 634829b1-b929-4958-813d-dabd8e7661f2
            Updater = GetDefaultUpdater();
        }
#endregion 3957ImportCode
#region 0169ImportCode
		public DateTime GetDefaultUpdate(View view = null)
        {
            //Code: 0169            Oid: 23064e1c-2230-4930-9cb9-c8c98243959d
            return (DateTime)Session.Evaluate(typeof(XPObjectType), new FunctionOperator(FunctionOperatorType.Now), null);
        }
#endregion 0169ImportCode
        #endregion
//Mã nguồn bổ sung
