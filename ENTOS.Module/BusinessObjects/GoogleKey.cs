...
namespace ENTOS.Module.BusinessObjects 
{
	...
	[DefaultClassOptions]
    [ModelDefault("Caption", "Google Key"), ImageName("GoogleKey")]
	...
	[MobileColumnAttribute(Context = "GoogleKey_ListView", TargetItems = nameof(FileData)+ "," + nameof(Name))]
	[MobileColumnAttribute(Context = "GoogleKey_LookupListView", TargetItems = nameof(Name))]
	[DefaultProperty("Name")]
 
[OptimisticLocking(true)]
    public partial class GoogleKey:  DevExpress.Xpo.XPLiteObject  , INoIndexColumn, IOnViewObjectSpaceCommitted      //, HbBaseObject
    {
        public GoogleKey(Session session)
            : base(session) {              
        }
...
//Kết thúc khổi phải là đối tượng NonPersistent (không lưu CSDL)
		...
		[VisibleInDetailView(true), VisibleInListView(true), VisibleInLookupListView(true)]
		[DevExpress.Xpo.DisplayName("Tập đính kèm")]
        [ToolTip("Tập đính kèm")]
		//[Index(1)]		
