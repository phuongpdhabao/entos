...
namespace ENTOS.Module.BusinessObjects 
{
	...
	[DefaultClassOptions]
    [ModelDefault("Caption", "Nhóm địa bàn"), ImageName("SpaceGroup")]
	...
	[MobileColumnAttribute(Context = "Space_SpaceGroups_ListView", TargetItems = nameof(Code))]
	[MobileColumnAttribute(Context = "SpaceGroup_LookupListView", TargetItems = nameof(Code))]
	[MobileColumnAttribute(Context = "SpaceGroup_ListView", TargetItems = nameof(Name)+ "," + nameof(Code))]
	[DefaultProperty("Code")]
 
[OptimisticLocking(true)]
    public partial class SpaceGroup:  DevExpress.Xpo.XPLiteObject  , INoIndexColumn, IOnViewObjectSpaceCommitted      //, HbBaseObject
    {
        public SpaceGroup(Session session)
            : base(session) {              
        }
...
//Kết thúc khổi phải là đối tượng NonPersistent (không lưu CSDL)
		...
		//[Index(0)]		
 		...
 		[Size(10)]
		[RuleUniqueValue("UniqueSpaceGroupCode", DefaultContexts.Save, CriteriaEvaluationBehavior = CriteriaEvaluationBehavior.BeforeTransaction)]
		public string Code
        { 
		...
		//[Index(1)]		
 		...
 		[Size(100)]
		[RuleRequiredField("RequiredSpaceGroupName", DefaultContexts.Save)]
		public string Name
        { 
		...
		//[Index(3)]
		[DataSourceCriteria("Not SpaceGroups[Oid = '@This.Oid']")]
		[DevExpress.Xpo.Association("SpaceGroups-Spaces")]
		//[CollectionOperationSet(AllowAdd = false, AllowRemove = false)]
		public XPCollection <Module.BusinessObjects.Space> Spaces
        {      
		    get => GetCollection<Module.BusinessObjects.Space>("Spaces"); 
		...
		public override void AfterConstruction()
        {
            ...
            #region 0404ImportCode
            base.AfterConstruction();
SetDefaultUpdate();
            #endregion 0404ImportCode
        ...
        {
            #region 0497ImportCode
            base.OnSaving();
SetDefaultUpdate();
            #endregion 0497ImportCode
...
#region 0061ImportCode
		public DateTime GetDefaultUpdate(View view = null)
        {
            //Code: 0061            Oid: 2a75b8ac-db3b-472c-b69d-f166c2afa6eb
            return (DateTime)Session.Evaluate(typeof(XPObjectType), new FunctionOperator(FunctionOperatorType.Now), null);
        }
#endregion 0061ImportCode
#region 0165ImportCode
		public void SetDefaultUpdate(View view = null)
        {
            //Code: 0165            Oid: 275fe6ba-996e-4919-b3e5-225d3a3a2f4f
            Update = GetDefaultUpdate();
        }
#endregion 0165ImportCode
        #endregion
//Mã nguồn bổ sung
