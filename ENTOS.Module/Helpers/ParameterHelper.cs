...
namespace ENTOS.Module.Helpers
{
    public static class ParameterHelper
    {
        ...
        public static void AddParameter(IObjectSpace objectSpace, string category, string name, object value,
        ...
        /// <example>
        /// <code>
        /// string maxSize = GetValue(session, "System", "MaxFileSize");
        /// string theme = GetValue(session, "UI", "DefaultTheme");
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// string appName = GetValue(session, "ApplicationName");
        /// string version = GetValue(session, "Version");
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// double maxSize = GetDoubleValue(session, "System", "MaxFileSize");
        /// double timeout = GetDoubleValue(session, "Network", "ConnectionTimeout");
        /// </code>
        /// </example>
        ...
        /// <example>
        /// <code>
        /// int maxUsers = GetIntValue(session, "System", "MaxUsers");
        /// int timeout = GetIntValue(session, "Network", "TimeoutSeconds");
        /// </code>
        /// </example>
        ...
        public static bool GetToBooleanValue(Session session, string module, string key)
        {
            ...
            try
            {
                string str = GetValue(session, module, key);
        ...
        public static bool GetToBooleanValue(IObjectSpace objectSpace, string module, string key)
        {
            ...
            try
            {
                string str = GetValue(objectSpace, module, key);
                if (!string.IsNullOrEmpty(str))
                    return Convert.ToBoolean(str);
                return false;
            }
