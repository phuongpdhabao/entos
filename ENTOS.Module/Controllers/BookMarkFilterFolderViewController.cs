...
{    
    public partial class BookMarkFilterFolderViewController : ViewController<ListView>
    {
        ...
        //    }
        //}
        public BookMarkFilterFolderViewController()
        {
            filteringCriterionAction = new SingleChoiceAction(
                    this, "BookMarkFilterFolderCriterion", PredefinedCategory.PopupActions);
        ...
        protected override void OnViewControlsCreated()
        {
            ...
            if (listview != null)
            {
                ...
                if (filteringCriterionAction.SelectedItem == null)
                {
                    var criteria = CriteriaOperator.Parse("UpperFolder is null");
