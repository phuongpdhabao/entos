...
{
    public partial class IFolderLookupViewController: ViewController
    {      
        
        public IFolderLookupViewController()
        {
            InitializeComponent();
            TargetObjectType = typeof(ENTOS.Module.BusinessObjects.IFolderLookup);    
