...
{
    public partial class IFolderProductTypeViewController: ViewController
    {      
        
        public IFolderProductTypeViewController()
        {
            InitializeComponent();
            TargetObjectType = typeof(ENTOS.Module.BusinessObjects.IFolderProductType);    
