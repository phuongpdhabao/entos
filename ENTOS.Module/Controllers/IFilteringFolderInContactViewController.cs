...
{
    public partial class IFilteringFolderInContactViewController: ViewController
    {      
        
        public IFilteringFolderInContactViewController()
        {
            InitializeComponent();
            TargetObjectType = typeof(ENTOS.Module.BusinessObjects.IFilteringFolderInContact);    
