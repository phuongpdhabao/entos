...
{
    public partial class IOrgDivisionViewController: ViewController
    {      
        
        public IOrgDivisionViewController()
        {
            InitializeComponent();
            TargetObjectType = typeof(ENTOS.Module.BusinessObjects.IOrgDivision);    
