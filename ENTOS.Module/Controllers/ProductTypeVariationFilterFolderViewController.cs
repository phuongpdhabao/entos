...
{    
    public partial class ProductTypeVariationFilterFolderViewController : ViewController
    {
        ...
        //    }
        //}
        public ProductTypeVariationFilterFolderViewController()
        {
            filteringCriterionAction = new SingleChoiceAction(
                    this, "ProductTypeVariationFilterFolderCriterion", PredefinedCategory.PopupActions);
            ...
            TargetObjectType = typeof(Module.BusinessObjects.ProductTypeVariation);
        ...
        private void CreateDefaultFilter(CriteriaOperator criteria)
        {
            ...
            foreach (var folder in listFolder.OrderBy(m => m.Name))
            {
                ...
                {
                    string data = "[ProductType.Folder.Oid] = ?";
