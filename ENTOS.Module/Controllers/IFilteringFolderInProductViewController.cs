...
{
    public partial class IFilteringFolderInProductViewController: ViewController
    {      
        
        public IFilteringFolderInProductViewController()
        {
            InitializeComponent();
            TargetObjectType = typeof(ENTOS.Module.BusinessObjects.IFilteringFolderInProduct);    
